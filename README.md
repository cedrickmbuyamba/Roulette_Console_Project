...
On start-up, load a file which contains a list of player's names, For my case I did create a file named "file.txt" which contains two names of two players, thjis txt file is commited as well.
...
1-36, EVEN or ODD), and how much they want to bet, For example Tiki_monkey as a player name, 2 number what they want to bet and how 3.0 as a bet's amount.
To make it clear the player should write Tiki_Monkey 2 3.0
...
We will have to excepect a such out put
...
Once in the folder called Part2, you follow thes command lines sice we have diffrentes folds in which we have the txt file and the main file as well,
